 ...
 */
final class Version20220511105306 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit CHANGE nom_pdt nom_pdt VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(30) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP FOREIGN KEY FK_29A5EC27FAABF2');
        $this->addSql('ALTER TABLE produit CHANGE nom_pdt nom_pdt VARCHAR(30) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL');
